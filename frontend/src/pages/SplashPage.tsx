...
export const SplashPage: React.FC = () => {
  ...
  return (
    <div className={`min-h-screen ${isDark ? 'bg-[#0a0a0a]' : 'bg-gray-50'}`}>
      ...
      {/* Features Section */}
      <div className={`py-24 ${isDark ? 'bg-[#111]' : 'bg-white'}`}>
      ...
      {/* Stats Section */}
      <div className={`py-16 ${isDark ? 'bg-[#0a0a0a]' : 'bg-gray-50'}`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div>
              <div className={`text-3xl md:text-4xl font-bold mb-2 ${isDark ? 'text-[#e11d2a]' : 'text-red-600'}`}>
                $8.7M
              </div>
